...
void creatore_sottoreti_supernetting_c(int *ip_dec){
...
void creatore_sottoreti_supernetting_b(int *ip_dec){
  indirizzi_supernet ip;
  int somma;
  int resto;
  int *host_sottorete;
...
void creatore_sottoreti_supernetting_a(int *ip_dec){
  indirizzi_supernet ip;
  int somma;
  int resto;
  int *host_sottorete;
